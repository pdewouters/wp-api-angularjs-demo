<?php
/**
 * pdw_wpc_gh_star post type handlers
 *
 * @package WordPress
 * @subpackage JSON API
 */
 ...
 * @subpackage JSON API
 */
class WP_JSON_Stars extends WP_JSON_CustomPostType {
	/**
	 * Base route
	 *
	 * @var string
	 */
	protected $base = '/stars';
	 ...
	 * @var string
	 */
	protected $type = 'pdw_wpc_gh_star';
	...
	/**
	 * Retrieve a pdw_wpc_gh_star by path name
	 *
	 * @param string $path
	 */
	public function get_post_by_path( $path, $context = 'view' ) {
		$post = get_page_by_path( $path, ARRAY_A, 'pdw_wpc_gh_star' );
